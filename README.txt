...
bitnami-drupal-7.34-1-linux-installer.run on Linux or
bitnami-drupal-7.34-1-linux-x64-installer.run on Linux or
bitnami-drupal-7.34-1-windows-installer.exe on Windows or
bitnami-drupal-7.34-1-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-drupal-7.34-1-linux.run
...
Stack in /home/user/drupal-7.34-1 on Linux or C:\Program Files\Bitnami Drupal Stack
on Windows or /Applications/drupal-7.34-1 on OS X and that you use port 
...
"Cannot open bitnami-drupal-7.34-1-linux.run: No application suitable for
...
/Applications/drupal-7.34-1/apache2/logs/error.log.
