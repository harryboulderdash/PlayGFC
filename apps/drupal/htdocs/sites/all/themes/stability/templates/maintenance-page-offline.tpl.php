        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <h1><?php print t('Something awesome is coming...'); ?></h1>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-md-4">
                <?php print t('Copyright') . ' &copy; '. date('Y'); ?>  <a href="<?php print $front_page;?>">Gaming For Cancer, LLC.</a> &nbsp;| &nbsp; <?php print t('All Rights Reserved'); ?>
              </div>
